...
static const unsigned char so_qt_viewing_bits[] = {
...
static const unsigned char so_qt_viewing_mask_bits[] = {
...
static const unsigned char so_qt_curved_hand_bits[] = {
   0x00, 0x00, 0x00, 0x00, 0x06, 0x00, 0x70, 0x69, 0x00, 0x88, 0x91, 0x00,
   0x08, 0x33, 0x01, 0x30, 0x66, 0x02, 0x20, 0x44, 0x04, 0x40, 0xcc, 0x04,
   0x80, 0x88, 0x08, 0x84, 0x08, 0x08, 0x9a, 0x00, 0x08, 0xa2, 0x00, 0x10,
   0xa2, 0x00, 0x10, 0x44, 0x00, 0x10, 0x08, 0x00, 0x10, 0x08, 0x00, 0x20,
...
static const unsigned char so_qt_curved_hand_mask_bits[] = {
...
static const unsigned char so_qt_flat_hand_bits[] = {
...
static const unsigned char so_qt_flat_hand_mask_bits[] = {
   0xff, 0xff, 0x03, 0x01, 0x00, 0x02, 0x01, 0x00, 0x02, 0x01, 0x00, 0x03,
...
static const unsigned char so_qt_pointing_hand_bits[] = {
...
static const unsigned char so_qt_pointing_hand_mask_bits[] = {
...
static const unsigned char so_qt_roll_bits[] = {
...
static const unsigned char so_qt_roll_mask_bits[] = {
...
static const unsigned char so_qt_target_bits[] = {
...
static const unsigned char so_qt_target_mask_bits[] = {
...
static const unsigned char so_qt_normal_vec_bits[] = {
...
static const unsigned char so_qt_normal_vec_mask_bits[] = {
...
static const unsigned char so_qt_walk_bits[] = {
...
static const unsigned char so_qt_walk_mask_bits[] = {
...
static const unsigned char so_qt_pan_bits[] = {
...
static const unsigned char so_qt_pan_mask_bits[] = {
...
static const unsigned char so_qt_tilt_bits[] = {
   0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
   0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
   0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
static const unsigned char so_qt_tilt_mask_bits[] = {
...
QCursor SoQtIcons::getCursor (int number)
{
    ...
    if (cachedCursors [number] == nullptr) {
        ...
        switch (number) {
        case CURSOR_VIEWING:
            size = QSize (16, 16); hotX = 1; hotY = 1;
            bits = QBitmap::fromData (size, so_qt_viewing_bits);
            mask = QBitmap::fromData (size, so_qt_viewing_mask_bits);
            break;
        case CURSOR_CURVED_HAND:
            size = QSize (24, 24); hotX = 4; hotY = 2;
            bits = QBitmap::fromData (size, so_qt_curved_hand_bits);
            mask = QBitmap::fromData (size, so_qt_curved_hand_mask_bits);
            break;
        case CURSOR_FLAT_HAND:
            size = QSize (24, 28); hotX = 13; hotY = 4;
            bits = QBitmap::fromData (size, so_qt_flat_hand_bits);
            mask = QBitmap::fromData (size, so_qt_flat_hand_mask_bits);
            break;
        case CURSOR_POINTING_HAND:
            size = QSize (24, 24); hotX = 9; hotY = 4;
            bits = QBitmap::fromData (size, so_qt_pointing_hand_bits);
            mask = QBitmap::fromData (size, so_qt_pointing_hand_mask_bits);
            break;
        case CURSOR_ROLL:
            size = QSize (24, 24); hotX = 9; hotY = 11;
            bits = QBitmap::fromData (size, so_qt_roll_bits);
            mask = QBitmap::fromData (size, so_qt_roll_mask_bits);
            break;
        case CURSOR_TARGET:
            size = QSize (24, 24); hotX = 11; hotY = 11;
            bits = QBitmap::fromData (size, so_qt_target_bits);
            mask = QBitmap::fromData (size, so_qt_target_mask_bits);
            break;
        case CURSOR_NORMAL_VEC:
            size = QSize (24, 24); hotX = 12; hotY = 17;
            bits = QBitmap::fromData (size, so_qt_normal_vec_bits);
            mask = QBitmap::fromData (size, so_qt_normal_vec_mask_bits);
            break;
        case CURSOR_WALK:
            size = QSize (32, 24); hotX = 15; hotY = 3;
            bits = QBitmap::fromData (size, so_qt_walk_bits);
            mask = QBitmap::fromData (size, so_qt_walk_mask_bits);
            break;
        case CURSOR_PAN:
            size = QSize (24, 24); hotX = 9; hotY = 1;
            bits = QBitmap::fromData (size, so_qt_pan_bits);
            mask = QBitmap::fromData (size, so_qt_pan_mask_bits);
            break;
        case CURSOR_TILT:
            size = QSize (32, 32); hotX = 7; hotY = 10;
            bits = QBitmap::fromData (size, so_qt_tilt_bits);
            mask = QBitmap::fromData (size, so_qt_tilt_mask_bits);
            break;
        }
        
        // This part is necessary to achieve proper scaling on Retina displays:
        QPixmap cursorPixmap = QPixmap::fromImage(bits.toImage());
        cursorPixmap.setMask(mask);

        cachedCursors[number] = new QCursor (cursorPixmap, hotX, hotY);
    }
