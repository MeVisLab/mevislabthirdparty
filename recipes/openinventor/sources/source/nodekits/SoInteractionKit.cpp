...
SoInteractionKit::setPartAsDefault(const SbName &partName, 
                               const SbName &newNodeName, bool onlyIfAlready )
{
...
SoInteractionKit::setAnyPartAsDefault(const SbName &partName, 
                        const SbName &newPartName, bool anyPart,
                        bool onlyIfAlready )
{
...
bool 
SoInteractionKit::setAnyPartAsDefault(const SbName &partName, 
                        SoNode *newNode, bool anyPart, bool onlyIfAlready )
{
...
////////////////////////////////////////////////////////////////////////
{
    ...
    //4-Determine if we can set any part by examining leafCheck & publicCheck
        bool anyPart = ( !leafCheck && !publicCheck );
...
//
SoNode *
SoInteractionKit::getAnyPart( const SbName &partName, bool makeIfNeeded,
                              bool leafCheck, bool publicCheck )
//
////////////////////////////////////////////////////////////////////////
{
...
SoInteractionKit::setAnySurrogatePath( const SbName &partName, 
                        SoPath *from, bool leafCheck, bool publicCheck )
//
////////////////////////////////////////////////////////////////////////
{
    // Strategy:
    ...
    //        we do when 'from' is NULL.
        if (from == NULL) {
            ...
            if ( dotPtr != NULL || brackPtr != NULL ) {
                char *nameCopy = oiv_strdup( partName.getString() );
                char *firstName;
                if (dotPtr == NULL)
...
SoInteractionKit::isPathSurrogateInMySubgraph( const SoPath *pathToCheck,
                       ...
                       SoPath *&surrogatePathInOwner, bool fillArgs )
//
////////////////////////////////////////////////////////////////////////
{
    ...
    // Get the paths to the InteractionKits
        ...
        bool oldNkVal = SoBaseKit::isSearchingChildren();
...
SoInteractionKit::readInstance( SoInput *in, unsigned short flags )
{
    // Start with base kit functionality...
        bool answer = SoBaseKit::readInstance(in, flags);
...
void
SoInteractionKit::connectSeparatorFields( SoSeparator *dest, bool onOff )
{
    if (dest == NULL)
        return;
    if (onOff) {
