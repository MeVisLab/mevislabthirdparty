...
SoGlobalField *
SoGlobalField::create(const SbName &name, SoType type, bool &alreadyExists)
//
//////////////////////////////////////////////////////////////////////////////
{
...

{
    ...
    const char* key = getName().getString();
    nameDict->remove(key);
...
void
SoGlobalField::addWriteReference(SoOutput *out, bool)
//
////////////////////////////////////////////////////////////////////////
{
