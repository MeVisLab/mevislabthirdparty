...
SO_MFIELD_SOURCE_MALLOC(SoMFMatrixd, SbMatrixd, const SbMatrixd &);
...
void
SoMFMatrixd::setValue(double a11, double a12, double a13, double a14,
...
bool
SoMFMatrixd::read1Value(SoInput *in, int index)
//
////////////////////////////////////////////////////////////////////////
{
...
void
SoMFMatrixd::write1Value(SoOutput *out, int index) const
//
////////////////////////////////////////////////////////////////////////
{
    int         i;
