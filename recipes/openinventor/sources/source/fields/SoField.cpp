...
void
SoField::enableConnection(bool flag)
//
////////////////////////////////////////////////////////////////////////
{
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (cont != NULL) {
        ...
        bool profilingEntered = SoProfiling::isEnabled() && (SoProfiling::getEnterScopeFieldNotifyCB()!=NULL)
          && (cont->getTypeId() != SoGlobalField::getClassTypeId());
        if (profilingEntered) {
          (*SoProfiling::getEnterScopeFieldNotifyCB())(this);
        }
...
bool
SoField::enableNotify(bool flag)
//
////////////////////////////////////////////////////////////////////////
{
...
{
  bool oldFlag = flags.notifyContainerEnabled;
...
////////////////////////////////////////////////////////////////////////
{
    ...
    SoFieldContainer *container;
    bool             containerKnownToBeEngine = FALSE;
...
void
SoField::valueChanged(bool resetDefault)      // Default is TRUE
//
////////////////////////////////////////////////////////////////////////
{
    if (resetDefault)
...
////////////////////////////////////////////////////////////////////////
{
    ...
    // This uses the virtual "=" operator, which should do the right thing.
        ...
        bool notifySave = f->flags.notifyEnabled;
...
////////////////////////////////////////////////////////////////////////
{
    if (out->getStage() == SoOutput::COUNT_REFS)
        ...
        bool writeConn = isConnected() && isConnectionEnabled();
