...
SO_SFIELD_SOURCE(SoSFPlaned, SbPlaned, const SbPlaned &);
...
bool
SoSFPlaned::readValue(SoInput *in)
//
////////////////////////////////////////////////////////////////////////
{
    SbVec3d     normal;
    ...
    setValue(SbPlaned(normal, distance));
...
void
SoSFPlaned::writeValue(SoOutput *out) const
//
////////////////////////////////////////////////////////////////////////
{
    const SbVec3d    &normal = value.getNormal();
