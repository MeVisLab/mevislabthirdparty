...
struct SoFieldEntry {
    ...
    ssize_t             offset;         // Offset of field within object
};
...
////////////////////////////////////////////////////////////////////////
{
    ...
    bool hadFieldsDefined = fields.getLength() > 0;
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (out->getStage() == SoOutput::WRITE) {
        ...
        bool isBuiltIn = container->getIsBuiltIn();
...
////////////////////////////////////////////////////////////////////////
{
    ...
    removedFields = from->removedFields;
}
