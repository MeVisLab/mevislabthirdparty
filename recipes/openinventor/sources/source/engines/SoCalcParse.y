...
%token LEXERR
%token <expr> CONST_EXP FUNC_EXP INPUT_EXP OUTPUT_EXP VAR_EXP
...
asgn:
	OUTPUT_EXP '=' conditional_expression
				{ $$ = new Assign($1, $3); }
	| OUTPUT_EXP '[' conditional_expression ']' '=' conditional_expression
				{ $$ = new AssignIndex($1, $3, $6); }
	| VAR_EXP	'=' conditional_expression
				{ $$ = new Assign($1, $3); }
	| VAR_EXP '[' conditional_expression ']' '=' conditional_expression
				{ $$ = new AssignIndex($1, $3, $6); }
	;
...
postfix_expression:
        ...
        | postfix_expression '[' conditional_expression ']'
			 	{ $$ = new Index($1, $3); }
	| FUNC_EXP '(' args ')'	{ ((Func *)$1)->setArgs($3); $$ = $1; }
        ;
