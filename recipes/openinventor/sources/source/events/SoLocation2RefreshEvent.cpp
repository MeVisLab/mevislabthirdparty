 ...
 *
 *   \file    SoLocation2RefreshEvent.cpp
 *   \author  Uwe Siems
 *   \date    08/2012
 */
...
SO_EVENT_SOURCE(SoLocation2RefreshEvent);

void SoLocation2RefreshEvent::initClass(void)
{
  SO_EVENT_INIT_CLASS(SoLocation2RefreshEvent, SoLocation2Event);
}
