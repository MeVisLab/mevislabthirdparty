...
bool
SoDB::registerHeader(const SbString &header, bool isBinary, float ivVersion,
...
SoDB::getHeaderData(const SbString &header, 
                    ...
                    void *&userData, bool substringOK)
//
////////////////////////////////////////////////////////////////////////
{    
    int whichHeader = -1;
...
void
SoDB::enableRealTimeSensor(bool enable)
//
////////////////////////////////////////////////////////////////////////
{
    if (enable && realTimeSensor->getInterval() != SbTime::zero()) {
        ...
        // notifying.
        bool wasEnabled = realTime->enableNotify(FALSE);
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (dataFileName != NULL) {
        ...
        if ((slashPtr = strrchr(dataFileName, '/')) != NULL) {
            searchPath = oiv_strdup(dataFileName);
