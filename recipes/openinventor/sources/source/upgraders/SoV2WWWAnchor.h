...
class SoV2WWWAnchor : public SoUpgrader {
  ...
  public:
    ...
    //! \name Fields
    //@{
    //! URL to fetch when activated by mouse click
    SoSFString  name;        
    //! Description of the URL that will be grabbed
    SoSFString  description; 
    //! What additional info to add to the URL
    SoSFEnum    map;         
    //! This is what's different from the 2.1 version!
  ...
  SoINTERNAL public:
    ...
    virtual bool upgrade(SoInput *in, const SbName &refName, SoBase *&result);    
