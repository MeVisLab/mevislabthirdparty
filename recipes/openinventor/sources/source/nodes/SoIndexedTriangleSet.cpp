...
SO_NODE_SOURCE(SoIndexedTriangleSet);
...
////////////////////////////////////////////////////////////////////////
{
  SO_NODE_CONSTRUCTOR(SoIndexedTriangleSet);
...
void
SoIndexedTriangleSet::GLRender(SoGLRenderAction *action)
//
////////////////////////////////////////////////////////////////////////
{
...
void
SoIndexedTriangleSet::generatePrimitives(SoAction *action)
//
////////////////////////////////////////////////////////////////////////
{
  SoState *state = action->getState();
...
SoDetail *
SoIndexedTriangleSet::createTriangleDetail(SoRayPickAction *action,
...
SoIndexedTriangleSet::Binding
SoIndexedTriangleSet::getMaterialBinding(SoAction *action)
//
////////////////////////////////////////////////////////////////////////
{
...
SoIndexedTriangleSet::Binding
SoIndexedTriangleSet::getNormalBinding(SoAction *action, SoNormalBundle *nb)
//
////////////////////////////////////////////////////////////////////////
{
...
bool
SoIndexedTriangleSet::figureNormals(SoState *state, SoNormalBundle *nb)
//
////////////////////////////////////////////////////////////////////////
{
  ...
  if (normalIndex.getNum() == 1 && normalIndex[0] == -1)
    nIndices = &coordIndex;
  else
...
bool
SoIndexedTriangleSet::generateDefaultNormals(SoState *state, SoNormalBundle *nb)
//
////////////////////////////////////////////////////////////////////////
{
...
void
SoIndexedTriangleSet::notify(SoNotList *list)
//
////////////////////////////////////////////////////////////////////////
{
...
///////////////////////////////////////////////////////////////////////////
void 
SoIndexedTriangleSet::setupNumTrisQuadsFaces()
{
  numTris = coordIndex.getNum()/3;
}    

void SoIndexedTriangleSet::GLRenderInternal( SoGLRenderAction * action , uint32_t useTexCoordsAnyway, const SoShapeStyleElement * shapeStyle)
{
  SoState * state = action->getState();
    ...
    (textureCoordIndex.getNum()==1 && textureCoordIndex.getValues(0)[0]==-1))
  {
    ...
    if (numTris > 0) {
      ...
      _triangleIndexer->setType(sendAdjacency.getValue()?GL_TRIANGLES_ADJACENCY:GL_TRIANGLES);

      if (_triangleIndexer->getDataId()!=getNodeId()) {
        _triangleIndexer->setIndices(coordIndex.getNum(), coordIndex.getValues(0), getNodeId());
      }
      _triangleIndexer->render(state, useVBO);

#ifdef DEBUG
      if (SoDebug::GetEnv("IV_DEBUG_VBO_RENDERING")) {
        SoDebugError::postInfo("GLRenderInternal", "%s VA Rendering: %d Triangles", getTypeId().getName().getString(), numTris);
      }
#endif
...
#include <SoIndexedTriangleSet_generated.cpp>
