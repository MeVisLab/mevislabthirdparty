...
////////////////////////////////////////////////////////////////////////
{
    ...
    SO_NODE_ADD_FIELD(disableDepthBuffer, (true));
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (action->isRenderingDelayedPaths()) {
        bool zbuffEnabled = glIsEnabled(GL_DEPTH_TEST)!=0;
    ...
    // node last
        ...
        if (action->getAllowDelayedPaths()) {
          action->addDelayedPath(action->getCurPath()->copy());
        } else {
          SoError::post("SoAnnotation can not be used at this position in the scene graph.");
        }
    }
}
