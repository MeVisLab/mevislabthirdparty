...
////////////////////////////////////////////////////////////////////////
{
    ...
    SbGL::glLightfv((GLenum) id, GL_SPOT_DIRECTION, direction.getValue().getValue());
//???
...
//???
    ...
    if (dropRate <= 0.0)
        SbGL::glLightf((GLenum) id, GL_SPOT_EXPONENT, .01);
    else 
        SbGL::glLightf((GLenum) id, GL_SPOT_EXPONENT,  dropRate * 128.0);
    SbGL::glLightf((GLenum) id, GL_SPOT_CUTOFF, cutOffAngle.getValue()*(180.0/M_PI));
