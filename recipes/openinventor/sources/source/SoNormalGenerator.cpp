...
SoNormalGenerator::SoNormalGenerator(bool _isCCW)
//
////////////////////////////////////////////////////////////////////////
{
    // Make some room
...
SoNormalGenerator::SoNormalGenerator(bool _isCCW, int approxNumVertices)
//
////////////////////////////////////////////////////////////////////////
{
...
////////////////////////////////////////////////////////////////////////
{
    ...
    for(i = 0; i < numPoints; i++) {
        ...
        bool isDegenerate = equal(zeroVec, sum, 1.e-4);
