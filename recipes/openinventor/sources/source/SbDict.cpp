...
void
SbDict::addEntryToPLists(size_t key, void *value, void *data)
{
...
void
SbDict::applyToAll(void (*rtn)(size_t key, void *value) )
{
    int         i;
    SbDictEntry *entry;
...
void
SbDict::applyToAll(void (*rtn)(size_t key, void *value, void *data),
                   void *data )
{
    int         i;
    SbDictEntry *entry;
...
bool
SbDict::enter(size_t key, void *value)
{
...
bool
SbDict::find(size_t key, void *&value) const
{
    SbDictEntry         *&entry = findEntry(key);
...
SbDictEntry *&
SbDict::findEntry(size_t key) const
{
    SbDictEntry         **entry;
