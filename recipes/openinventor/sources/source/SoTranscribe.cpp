...
void
SoTranSender::addNode(SoNode *node, bool addNames)
//
////////////////////////////////////////////////////////////////////////
{
...
bool
SoTranReceiver::interpretCommand(int commandCode, SoInput *in, bool &done)
//
////////////////////////////////////////////////////////////////////////
{
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (lookForNode) {
        ...
        if (nameToEntryDict.find(name.getString(), ptr)) {
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (--e->refCount == 0) {
        ...
        nameToEntryDict.remove(name.getString());
        nodeToNameDict.remove(node);
        e->node->unref();
        delete e;
...
////////////////////////////////////////////////////////////////////////
{
    ...
    nameToEntryDict.enter(name.getString(), (void *) e);
    nodeToNameDict.enter(node, (void *) name.getString());
}
...
void
SoTranReceiver::deleteDictEntry(size_t, void *value)
//
////////////////////////////////////////////////////////////////////////
{
