...
SoSpotLightDragger::SoSpotLightDragger()
{
    ...
    if (SO_KIT_IS_FIRST_INSTANCE())
        readDefaultParts( "spotLightDragger.iv", (const char*)geomBuffer, sizeof(geomBuffer) );
...
////////////////////////////////////////////////////////////////////////
{
    ...
    // vector from (0,0,0) to newHitPt.
        ...
        // If we've gone 'out of bounds' let's figure out what to do...
            ...
            bool isNewOppositeStart = ( newCross.dot(startCross) < 0.0 );
