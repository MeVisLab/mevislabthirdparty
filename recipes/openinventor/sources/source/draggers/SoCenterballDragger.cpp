...
////////////////////////////////////////////////////////////////////////
{
    ...
    if ( SO_KIT_IS_FIRST_INSTANCE())
        readDefaultParts("centerballDragger.iv", (const char*)geomBuffer, sizeof(geomBuffer));
...
SoCenterballDragger::valueChangedCB(void *, SoDragger *inDragger )
{
    ...
    // centerDragger motion into our 'translateToCenter' matrix.
        ...
        if ( cd != NULL &&
            ...
            bool saveEnabled = dBall->enableValueChangedCallbacks( FALSE );
...
SoCenterballDragger::setSwitches( SoDragger *activeChild )
{
    ...
    bool freeRotate = ( activeChild && activeChild == rotator.getValue());
    bool changeCenter = (     activeChild && 
                            (   activeChild == XCenterChanger.getValue() 
                             || activeChild == YCenterChanger.getValue() 
                             || activeChild == ZCenterChanger.getValue()));
    bool xRotate = (activeChild && activeChild == XRotator.getValue());
    bool yRotate = (activeChild && activeChild == YRotator.getValue());
    bool zRotate = (activeChild && activeChild == ZRotator.getValue());
