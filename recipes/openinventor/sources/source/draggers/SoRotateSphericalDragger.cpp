...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (SO_KIT_IS_FIRST_INSTANCE())
        readDefaultParts("rotateSphericalDragger.iv", (const char*)geomBuffer, sizeof(geomBuffer) );
...
////////////////////////////////////////////////////////////////////////
{
  ...
  // we do not overwrite prevWorldHitPt. Also, we do not need to modify any matrices
  // That way, small changes are accumulated until a valid rotation can be computed
