...
////////////////////////////////////////////////////////////////////////
{
    ...
    SoGLVBOElement::unsetVBOIfEnabled(state, SoGLVBOElement::TEXCOORD_VBO);

    SoTextureCoordinateElement  *elt = (SoTextureCoordinateElement *)getElement(state, classStackIndex, node);
