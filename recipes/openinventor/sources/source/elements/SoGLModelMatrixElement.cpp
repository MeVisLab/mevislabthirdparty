...
////////////////////////////////////////////////////////////////////////
{
    ...
    SbGL::glLoadMatrixf((float *) viewMat.getValue());
}
...
////////////////////////////////////////////////////////////////////////
{
    ...
    SbGL::glLoadMatrixf((float *) (matrix * viewMat).getValue());
}
...
////////////////////////////////////////////////////////////////////////
{
    ...
    SbGL::glMultMatrixf((float *) matrix.getValue());
}
...
////////////////////////////////////////////////////////////////////////
{
    ...
    SbGL::glTranslatef(translation[0], translation[1], translation[2]);
}
...
////////////////////////////////////////////////////////////////////////
{
    ...
    SbGL::glRotatef(angle * (180.0 / M_PI), axis[0], axis[1], axis[2]);
}
...
////////////////////////////////////////////////////////////////////////
{
    ...
    SbGL::glScalef(scaleFactor[0], scaleFactor[1], scaleFactor[2]);
}
...
////////////////////////////////////////////////////////////////////////
{
    ...
    SbNodeIdType afterNodeId = SoGLViewingMatrixElement::getNodeId(state);

    if (afterNodeId != viewEltNodeId) {
        // Camera underneath us, must reset:
        setElt(matrix);
    }
}
