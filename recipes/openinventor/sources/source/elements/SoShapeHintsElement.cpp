...
void
SoShapeHintsElement::set(SoState *state, bool _useVBO)
                         //
                         ////////////////////////////////////////////////////////////////////////
{
  SoShapeHintsElement *elt;
...
bool SoShapeHintsElement::isVBOUsed( SoState *state )
{
  const SoShapeHintsElement *elt = (const SoShapeHintsElement *) getConstElement(state, classStackIndex);
  return elt->useVBO;  
}
