            ...
            const SbColor *colors, SoColorPacker *cPacker)
{
    ...
    SoGLVBOElement::unsetVBOIfEnabled(state, SoGLVBOElement::COLOR_VBO);
...
void SoLazyElement::setDrawElementsCallback( SoState* state, SoDrawElementsCallback* cb, void* userData )
{
  SoLazyElement *curElt = SoLazyElement::getWInstance(state);
  curElt->ivState.drawElementsCallback = cb;
  curElt->ivState.drawElementsCallbackUserData = userData;
}

void SoLazyElement::setUseVertexAttributes( SoState* state, bool flag )
{
  SoLazyElement *curElt = SoLazyElement::getWInstance(state);
  curElt->ivState.useVertexAttributes = flag;
}

bool SoLazyElement::shouldUseVertexAttributes( SoState* state )
{
  SoLazyElement *curElt = SoLazyElement::getInstance(state);
  return curElt->ivState.useVertexAttributes;
}

void SoLazyElement::setDrawArraysCallback( SoState* state, SoDrawArraysCallback* cb, void* userData )
{
  SoLazyElement *curElt = SoLazyElement::getWInstance(state);
...
void SoLazyElement::drawArrays( SoState* state, GLenum mode, GLint first, GLsizei count )
{
  SoLazyElement *elt = getInstance(state);
  if (elt->ivState.drawArraysCallback) {
    (*elt->ivState.drawArraysCallback)(elt->ivState.drawArraysCallbackUserData, state, mode, first, count);
  } else {
...
void SoLazyElement::drawElements( SoState* state, GLenum mode, GLsizei count, GLenum type, const GLvoid * indices )
{
  SoLazyElement *elt = getInstance(state);
  if (elt->ivState.drawElementsCallback) {
    (*elt->ivState.drawElementsCallback)(elt->ivState.drawElementsCallbackUserData, state, mode, count, type, indices);
  } else {
...
///////////////////////////////////////////////////////////////////////  
void    
SoLazyElement::setBlending(SoState *state,  bool value)
{
  SoLazyElement *curElt = SoLazyElement::getInstance(state);
...
///////////////////////////////////////////////////////////////////////  
void    
  SoLazyElement::setOverrideBlending(SoState *state,  bool value)
{
  SoLazyElement *curElt = SoLazyElement::getInstance(state);
...
///////////////////////////////////////////////////////////////////////  
void    
SoLazyElement::setColorMaterial(SoState *state, bool value)
{
    SoLazyElement *curElt = SoLazyElement::getInstance(state);
    ...
    const SoMFFloat& shininess)
{
    ...
    SbNodeIdType nodeId = node->getNodeId();
...
void
SoLazyElement::setColorMaterialElt( bool value )
...
void
SoLazyElement::setBlendingElt(bool value )
