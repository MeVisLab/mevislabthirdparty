...
/////////////////////////////////////////////////////////////////////////
void
SoGLLazyElement::setBlendingElt(bool value)
{
...
SoGLLazyElement::sendVPPacked(SoState* state, const unsigned char* pcolor)
{
    ...
    SbGL::glColor4ubv((const GLubyte*)_pcolor);
    if (!(glState.GLColorMaterial || (glState.GLLightModel == BASE_COLOR))) {
        ...
        SbGL::glMaterialfv(GL_FRONT_AND_BACK, GL_DIFFUSE, col4);
    }
                ...
                case(DIFFUSE_CASE):
                    if (ivState.diffuseNodeId != 
                        ...
                        if (SoDebug::GetEnv("IV_DEBUG_CACHES")) {
                            ...
                            fprintf(stderr, "prev,  current %zu %zu, %zu %zu\n", 
        ...
        if (sendBits & 1){
            ...
            switch(j){
                ...
                case(DIFFUSE_CASE):              
                    ...
                    SbGL::glColor4ubv((GLubyte*)&pColors);
                    if (!(glState.GLColorMaterial || (glState.GLLightModel == BASE_COLOR))) {
                ...
                case(AMBIENT_CASE):     
                    ...
                    SbGL::glMaterialfv(GL_FRONT_AND_BACK,GL_AMBIENT,
                ...
                case(EMISSIVE_CASE):
                    ...
                    SbGL::glMaterialfv(GL_FRONT_AND_BACK,GL_EMISSION,
                ...
                case(SPECULAR_CASE):
                    ...
                    SbGL::glMaterialfv(GL_FRONT_AND_BACK,GL_SPECULAR,
                ...
                case(SHININESS_CASE):
                    ...
                    SbGL::glMaterialf(GL_FRONT_AND_BACK,GL_SHININESS,
...
SoGLLazyElement::packColors(SoColorPacker *cPacker)
{
    ...
    bool multTrans = (ivState.numTransparencies >= ivState.numDiffuseColors);    
    int indx = 0;
    uint32_t transp;
...
void SoGLLazyElement::updateColorVBO( SoState* state, SoVBO* vbo )
{
  SbNodeIdType maxId = ivState.diffuseNodeId;
  if (ivState.transpNodeId > maxId) {
    maxId = ivState.transpNodeId;
  }
  if (vbo->getDataId()!=maxId) {
    vbo->setData(ivState.numDiffuseColors * sizeof(uint32_t), ivState.packedColors, maxId, state);
  }
}