...
////////////////////////////////////////////////////////////////////////
{
    ...
    bool goVertical = (getWidth() > getHeight());
    ...
    if ( centerShifted == TRUE ) {
        bool isOk = plane.intersect(centerLine, worldSeedPoint);
    ...
    bool isOk = plane.intersect(offsetLine, worldOffsetPoint);
