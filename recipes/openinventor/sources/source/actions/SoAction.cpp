...
////////////////////////////////////////////////////////////////////////
{
    ...
    bool                needToRestore = isBeingApplied;
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (appliedTo.curPathCode == IN_PATH) {
        ...
        if (appliedTo.code == PATH_LIST) {
            bool        onPath = appliedTo.compactPathList->push(childIndex);
...
////////////////////////////////////////////////////////////////////////
{
    bool profilingEntered = SoProfiling::isEnabled() && (SoProfiling::getEnterScopeApplyActionCB()!=NULL);
    if (profilingEntered) {
      (*SoProfiling::getEnterScopeApplyActionCB())(this);
    }
...
SoAction::apply(const SoPathList &sortedList,
                const SoPathList &origPathList, bool isLastPathList)
//
////////////////////////////////////////////////////////////////////////
{
    // If we are already in the middle of being applied, save the
