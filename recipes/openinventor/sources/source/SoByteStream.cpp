...
//
void
SoByteStream::convert(SoPathList *pathList, bool binaryFormat)
//
//////////////////////////////////////////////////////////////////////////////
{
...
//
void
SoByteStream::convert(SoPath *path, bool binaryFormat)
//
//////////////////////////////////////////////////////////////////////////////
{
    SoPathList pathList;
...
//
void
SoByteStream::convert(SoNode *node, bool binaryFormat)
//
//////////////////////////////////////////////////////////////////////////////
{
...
//////////////////////////////////////////////////////////////////////////////
{
    ...
    if (data != NULL) {
        memcpy(data, d, len);
        // TODO: This is narrowing us to 32 bit:
        numBytes = static_cast<uint32_t>(len);
        isRaw = TRUE;
    }
}
