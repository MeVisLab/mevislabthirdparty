...
SoEXTENDER class INVENTOR_API SoGLLazyElement : public SoLazyElement {
  ...
  SoINTERNAL public:
    ...
    bool lazyMatches(uint32_t checkGLFlag, uint32_t checkIVFlag,
  ...
  private:         
    ...
    bool fullLazyMatches(uint32_t checkGLFlag, uint32_t checkIVFlag,
        const SoGLLazyElement* eltInState);
