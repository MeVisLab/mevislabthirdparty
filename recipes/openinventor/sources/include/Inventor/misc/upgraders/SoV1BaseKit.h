...
SoEXTENDER class SoV1BaseKit : public SoV1CustomNode {
  ...
  public:
    ...
    SoNode *getPart( const SbName &partName, const SoType &partType, 
                     bool makeIfNeeded, SoPath *inheritancePath = NULL);
  ...
  protected:
    ...
    bool tryToSetPartInNewNode( SoBaseKit *newNode,
    ...
    virtual bool dealWithUpgradedPart( SoBaseKit *newNode,
                                  SoNode *newPart, const SbName &newPartName );

    bool childOkInList(const SoNode *child,
    ...
    SoNode *getAnyPart( const SbName &partName, const SoType &partType, 
                        ...
                        bool publicCheck, SoPath *inheritancePath = NULL );
    bool setAnyPart( const SbName &partName, SoNode *from, bool anyPart );
