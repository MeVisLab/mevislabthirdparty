...
#define SO__FIELD_HEADER(className)                                           \
  ...
  SoINTERNAL public:                                                          \
    ...
    virtual bool                isSame(const SoField &f) const;               \
                                                                              \
  private:                                                                    \
...
#define SO__MFIELD_RW_HEADER(className)                                       \
  private:                                                                    \
    ...
    virtual bool                read1Value(SoInput *in, int index);           \
                                                                              \
...
{                                                                             \
    *this = * static_cast<const className *>(&f);                             \
}                                                                             \
                                                                              \
bool                                                                          \
...
#define SO_SFIELD_VALUE_HEADER(className, valueType, valueRef)                \
  ...
  public:                                                                     \
    ...
    bool                           operator ==(const className &f) const;        \
    bool                           operator !=(const className &f) const         \
        { return ! ((*this) == f); }                                          \
                                                                              \
  protected:                                                                  \
...
#define SO_MFIELD_VALUE_HEADER(className, valueType, valueRef)                \
  ...
  public:                                                                     \
    ...
    const valueType *           getValues(int start) const                    \
        { evaluate(); return const_cast<const valueType *>(values + start); } \
                                                                              \
...
#define SO_MFIELD_VALUE_SOURCE(className, valueType, valueRef)                \
                                                                              \
int                                                                           \
className::find(valueRef targetValue, bool addIfNotFound)                   \
{                                                                             \
    ...
    for (i = 0; i < localNum; i++)                                                    \
        if (values[i] == targetValue)                                         \
            return i;                                                         \
                                                                              \
    if (addIfNotFound)                                                        \
        set1Value(localNum, targetValue);                                             \
                                                                              \
    return -1;                                                                \
}                                                                             \
                                                                              \
void                                                                          \
className::setValues(int start, int localNum, const valueType *newValues)             \
{                                                                             \
...
{                                                                             \
    if (values == NULL) {                                                     \
        ...
        if (newNum > 0)                                                       \
            values = static_cast<valueType *>(realloc(values, sizeof(valueType)*newNum));\
        else {                                                                \
            free(values);                                                     \
            values = NULL;                                                    \
        }                                                                     \
