...
#ifndef  _SO_MF_VEC4D_
#define  _SO_MF_VEC4D_
...
SoMFVec4ds are written to file as one or more triples of floating
...
class INVENTOR_API SoMFVec4d : public SoMField {
  ...
  public:
    ...
    //! Set values from array of arrays of 4 doubles
